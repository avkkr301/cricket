...
import { Activity, ArrowRight, LockKeyhole, ShieldCheck, Trophy } from 'lucide-react';
...
export default function LoginPage() {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center bg-[#07111f]"><div className="h-8 w-8 animate-spin rounded-full border-4 border-[#f3b51b] border-t-transparent" /></div>;
  if (user) return null;
    ...
    <div className="login-glow flex min-h-screen items-center justify-center px-4 py-8">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-3xl border border-slate-700/50 bg-[#0a1728]/95 shadow-2xl lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button
            type="submit"
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#f3b51b] py-3 font-black text-[#07111f] transition hover:bg-[#ffd45b]"
          >
